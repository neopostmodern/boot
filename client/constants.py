...
ServoConfigs = {
  ...
  ServoName.RIDE: ServoConfig(ServoSide.RIGHT, ServosRightPin.RIDE, min_angle=20, max_angle=65), 
  ServoName.CROCO_BASE_RIGHT: ServoConfig(ServoSide.RIGHT, ServosRightPin.CROCO_BASE_RIGHT),
  ServoName.CROCO_BASE_CENTER: ServoConfig(ServoSide.RIGHT, ServosRightPin.CROCO_BASE_CENTER),
  ServoName.CROCO_BASE_LEFT: ServoConfig(ServoSide.LEFT, ServosLeftPin.CROCO_BASE_LEFT),
  ServoName.CROCO_JAW_RIGHT: ServoConfig(ServoSide.RIGHT, ServosRightPin.CROCO_JAW_RIGHT, min_angle=32, max_angle=55),
  ServoName.CROCO_JAW_CENTER: ServoConfig(ServoSide.LEFT, ServosLeftPin.CROCO_JAW_CENTER, min_angle=45, max_angle=62),
  ServoName.CROCO_JAW_LEFT: ServoConfig(ServoSide.LEFT, ServosLeftPin.CROCO_JAW_LEFT, min_angle=28, max_angle=40),
}
